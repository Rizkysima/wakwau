...
echo  "|                                                           |" | lolcat
echo  "|              Root®Autor      : Nicoleus Sitorus           |" | lolcat
echo  "|              Youtube         : ady sitorus ady            |" | lolcat
echo  "|              fACEBOOK        : Rizky Simamora             |" | lolcat
...
echo $i"|"$me" @"$i" |"$me" \-SEBAIKNYA INSTALL DULU BAHAN-BAHANYA Lae-/" $i"|"$me" @"$i" |"
echo $i"===================================================="
